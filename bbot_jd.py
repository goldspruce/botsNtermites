...
class BBot:
    ...
    def decide_and_move(self, current_steps):
        ...
        # 1. ALWAYS ensure the bot is trapped inside the walls, even if stopped/pushed
        # We put this at the top so sleeping bots don't clip through the wall when shoved.
