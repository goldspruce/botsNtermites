...
LIGHT_POS = (WIDTH // 2, HEIGHT // 2)  # Puts the light at (300, 300)
...
NUM_BLOCKS = 15                   # We will spawn exactly 20 rocks every trial.
BLOCK_RADIUS = 30                 # The radius for the circular rocks.
BBOT_RADIUS = 10                  # The radius of our circular bbots.
WALL_THICKNESS = 10               # How thick the yellow boundary lines are.

SHADOW_PROXIMITY_LIMIT = 60       # The max distance a bbot can be from a rock to consider itself "in a shadow".
