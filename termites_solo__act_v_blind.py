...
def run_trial(is_control):
    """
    Runs a single 1,000-step simulation. 
...
if __name__ == "__main__":
    ...
    with concurrent.futures.ProcessPoolExecutor(max_workers=num_cores) as executor:
        ...
        # as_completed() yields results the instant any single core finishes a simulation.
        # This is what allows us to update the progress bar smoothly in real-time.
        for future in concurrent.futures.as_completed(all_futures):
            ...
            # Save the Delta to the CSV file (much cleaner data)
    ...
    with open(csv_filename, 'w', newline='') as csvfile:
        ...
        # ---> NEW DELTA LOGIC <--- Updated CSV headers
    ...
    # ---> NEW DELTA LOGIC <--- We are now running the math on the Deltas
    ...
    report += "to eliminate baseline noise from randomly generated starting grids.\n\n"
